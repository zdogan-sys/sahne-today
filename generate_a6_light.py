...
if __name__ == '__main__':
    ...
    base.build_sanatci(  os.path.join(out, 'Sahne_Today_01_Sanatci_ve_Grup_A6_Beyaz.pdf'))
    base.build_mekan(    os.path.join(out, 'Sahne_Today_02_Mekan_A6_Beyaz.pdf'))
    base.build_izleyici( os.path.join(out, 'Sahne_Today_03_Izleyici_A6_Beyaz.pdf'))
